...
def get_args():
    ...
    parser.add_argument("--batch_step_lr", action="store_true")
...
def train_function(model, train_dataloader, val_dataloader, test_dataloader, args):
    ...
    optimizer = optim.AdamW(model.parameters(), lr=args.initial_lr, betas=(0.9, 0.99), weight_decay=1e-3)
...
def main():
    ...
    train_function(model, train_dataloader, test_dataloader, test_dataloader, args)
